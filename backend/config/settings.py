...
LLM_CONNECT_TIMEOUT_SECONDS = config("LLM_CONNECT_TIMEOUT_SECONDS", default=10, cast=int)
LLM_READ_TIMEOUT_SECONDS = config("LLM_READ_TIMEOUT_SECONDS", default=60, cast=int)
